...
var ClientDetailComponent = (function () {
    function SMovieDetailComponent(movieService, route, location) {
  ...
  ClientDetailComponent.prototype.goBack = function () {
    ...
    __decorate([
        core_1.Input()
    ], ClientDetailComponent.prototype, "movie", void 0);
...
exports.MovietDetailComponent = ClientDetailComponent;
